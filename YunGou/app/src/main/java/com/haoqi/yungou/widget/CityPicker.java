...
import com.haoqi.yungou.domain.Cityinfo;
import com.haoqi.yungou.util.CitycodeUtil;
...
public class CityPicker extends LinearLayout {
	...
	protected void onFinishInflate() {
		...
		countryPicker.setData(citycodeUtil.getCouny(couny_map, citycodeUtil
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case REFRESH_VIEW:
					...
					city.cityAll(provincePicker.getSelectedText(),cityPicker.getSelectedText(),countryPicker.getSelectedText());
					break;
				default:
					break;
			}
	...
	public String getAreaText(){
		return provincePicker.getSelectedText()+" "+cityPicker.getSelectedText()+" "+ countryPicker.getSelectedText();
	}
   ...
   public String getCountry(){
	   return countryPicker.getSelectedText();
   }
	public void setCity(CityCall testCityWbb){
