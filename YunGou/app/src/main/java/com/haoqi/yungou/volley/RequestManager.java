package com.haoqi.yungou.volley;
...
public class RequestManager {
	public static RequestQueue mRequestQueue = Volley.newRequestQueue(GlobalApplication.getContext());
	...
	public static void get(String url, Object tag, String progressTitle,
		...
		dialog.show(((Activity) tag).getFragmentManager(),
				"Loading");
